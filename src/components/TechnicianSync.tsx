  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors bg-blue-600 hover:bg-blue-700 text-white h-10 px-4 py-2 shadow-sm gap-2"
        aria-label="Sync technicians from FreshService"
      >
