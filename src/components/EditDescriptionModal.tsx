...
// Import the styles for the editor in a way compatible with Next.js
// Don't import the CSS directly, as it might cause issues with SSR
// We'll add it to a component that only renders client-side

// Create a separate client component for the editor to isolate it
const QuillEditor = dynamic(() => 
  import('./QuillEditorWrapper').then(mod => mod.QuillEditorWrapper), 
  { 
    ssr: false,
    loading: () => (
      <div className="h-full w-full flex items-center justify-center bg-white dark:bg-gray-800 rounded-md">
