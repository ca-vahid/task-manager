  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-full">
        {/* Left column - Task details - increased height for better visibility */}
        <div className="md:col-span-8 flex flex-col h-[350px]">
          <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
            Details
          </label>
          <div className={`flex-grow rounded-md overflow-hidden h-full flex flex-col ${
        ...
        {/* Right column - Task metadata fields - changed to 4/12 width (was 3/12) */}
      ...
      <div className="space-y-6 max-h-[calc(100vh-220px)] overflow-y-auto pr-2 pb-2 scrollbar">
        {editedTasks.map((task, index) => (
          <TaskReviewCard
            ...
            aiMatchedFields={aiMatchedFields[index] || {}}
